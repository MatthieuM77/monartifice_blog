# 17 · Mercredi 30 septembre 2026 · 12 h 30

| | |
|---|---|
| **Pilier** | 4 — Coulisses & métier |
| **Format** | Carrousel 4 slides — **photos réelles à shooter** |
| **Objectif** | Clore le mois sur le métier + amorcer octobre |

## Photos à prendre
Voir `COULISSES-PLAN-PHOTO.md` → séquence **F. Après le tir**.
Site au petit matin, dispositif éteint, ramassage des reliquats, sacs.
...
Contrôle du dispositif. Attente réglementaire avant manipulation. Ramassage de chaque reliquat, un par un, à la lampe.

On repart toujours quand le terrain est plus propre qu'à notre arrivée. Ce n'est pas une posture : un reliquat oublié dans l'herbe, c'est un risque pour celui qui tondra la semaine suivante.
...
Contrôle du dispositif. Attente réglementaire avant toute manipulation. Puis ramassage de chaque reliquat, un par un, à la lampe torche.

On repart toujours quand le terrain est plus propre qu'à notre arrivée. Ce n'est pas une posture commerciale : un reliquat oublié dans l'herbe, c'est un risque réel pour la personne qui tondra la semaine suivante.
