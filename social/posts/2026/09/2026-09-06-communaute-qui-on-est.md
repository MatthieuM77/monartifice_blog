# 03 · Dimanche 6 septembre 2026 · 11 h 00
...
une photo de travail. Voir `COULISSES-PLAN-PHOTO.md` → séquence **E. Portrait métier**.

## Visuel
Photo terrain, texte incrusté sobre : **« ARTIFICIERS DE MÉTIER »**

## Texte Instagram
On se présente, puisque ce compte commence.

On est artificiers. Pas revendeurs, pas intermédiaires : c'est notre métier, sur le terrain, avec les mains dedans.
...
→ Et bientôt, vous proposer notre sélection.

La boutique arrive. On vous en reparle très vite.

En attendant : si vous avez une question sur un projet, écrivez-nous en message privé. On répond à tout le monde 💬

#MonArtifice #artificier #feudartifice #pyrotechnie #metier #savoirfaire #presentation #feuxdartifice #artificierprofessionnel #france #nouveaucompte #expertise

## Texte Facebook
**On se présente, puisque ce compte commence.**

Nous sommes artificiers. Pas revendeurs, pas intermédiaires : c'est notre métier, sur le terrain, avec les mains dedans.

Ce compte va servir à trois choses :
...
🛒 **Et bientôt, vous proposer notre sélection.** La boutique arrive, on vous en reparle très vite.
