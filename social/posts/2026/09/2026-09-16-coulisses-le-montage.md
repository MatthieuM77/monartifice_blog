...
| **Format** | Reel vertical 9:16, 25-30 s — **tournage réel** |
| **Objectif** | Expertise + rétention (le format « process » retient très bien) |

## Vidéo à tourner
Voir `COULISSES-PLAN-PHOTO.md` → séquence **C. Montage**.
Suite de plans courts : déchargement, positionnement, calage, lestage, vérification.
Son d'ambiance, pas de musique épique.

## Visuel
Texte incrusté S1 : **« DE LA CAISSE AU DISPOSITIF »**
