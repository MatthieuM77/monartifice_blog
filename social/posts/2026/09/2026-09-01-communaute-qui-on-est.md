...
> Le titre parle des **personnes**, pas de la boutique : ce sont les gérants qui sont
> artificiers, Mon Artifice est un revendeur. Le texte fait la distinction dès la deuxième
> phrase. Ne pas transformer le titre en « votre boutique d'artificiers ».
...
## Note interne
**Positionnement.** Mon Artifice est une **boutique en ligne**, un revendeur, au même titre
que `sparklers-club.com`. Le différenciateur n'est pas de ne pas être revendeur — c'est que
la sélection est faite par des artificiers en exercice. Voir `STRATEGIE.md` § 11.
