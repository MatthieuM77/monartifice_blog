...
| Fichier | Usage |
|---|---|
| `liste-tournage-05-09.pdf` | **Liste de tournage du feu du 5 septembre 2026.** 39 plans, 2 pages A4, classés dans l'ordre de la journée : au montage, avant le tir, pendant, après. |
