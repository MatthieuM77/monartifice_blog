...
> **Aucun plan ne demande d'être côté public, ni près des mortiers pendant le tir.** Les gros
> plans se font avant, le spectacle se filme depuis le poste. C'est votre place réelle, et c'est
> précisément ce que personne d'autre ne peut montrer.
...
concurrent ne peut les produire.

> ### ⚠️ La règle, parce que le tir est électrique
>
> Personne n'est près des mortiers pendant le tir. Donc :
>
> - **Les gros plans du dispositif se font AVANT**, quand la zone est encore accessible.
> - **Pendant le tir, on filme uniquement depuis le poste**, à la distance de sécurité.
> - **Aucun matériel laissé près du dispositif.** Un téléphone posé là-bas, c'est un objet
>   qu'il faut aller rechercher — on ne tire pas en sachant ça.
>
> Le téléphone reste avec vous, sur trépied derrière le pupitre.

### Avant le tir — de près

| # | Plan | Note |
|---|---|---|
| T1 | Le dispositif monté, de dos, ciel encore vide | Ouverture parfaite |
| T2 | Les mortiers alignés, tubes vides, vus de dessus | Très graphique |
| T3 | Le câblage qui court au sol vers le pupitre | |
| **T4** | **La ligne de tir qui s'éloigne du dispositif jusqu'au poste** | Elle raconte la distance en une image |
...
| # | Plan | Note |
|---|---|---|
| T7 | Plan large : le dispositif qui tire, en entier | Donne le contexte et le lieu |
| **T8** | **Vous de dos au pupitre, le feu devant vous** | **Le plan qui vaut tous les autres.** Trépied derrière vous, lancé avant la clé. |
...
| T15 | Les tubes vides | Après la temporisation d'usage |
...
`T1` → `T15` · `G1` → `G8` · `H2` `H4` `H5`

**Priorité 3 — bonus (8 plans)**
`J1` → `J8`

> Si vous ne deviez en retenir que cinq : **T8** (vous au pupitre, le feu devant),
> **T4** (la ligne de tir qui s'éloigne), **H5** (le bouquet final), **F2** (le ramassage à
...
|---|---|---|
| L'autre côté du feu | 11/09 | `T1` → `T15` — **15 plans** : gros plans avant le tir, spectacle depuis le poste |
